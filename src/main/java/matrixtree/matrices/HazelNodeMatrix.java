 ...
 * Matrix form is {{1,1},{c,c+1}} where c is child position. Notation of this matrix is N[4] representing Node of the
 * 4th child. e.g. {{1,1},{4,4+1}}
 *
...
public class HazelNodeMatrix extends BaseMatrix implements StandardMatrix, SimpleInvertible {
	...
	public HazelNodeMatrix(StandardMatrix mat) {
		...
		Precondition.checkArgument(mat.getE11() == 1L && mat.getE12() == 1L,
				"Not Hazel Node! Element e11 and e12 must be 1! " + this);
		Precondition.checkArgument(mat.getE22() == mat.getE21() + 1,
				"Not Hazel Node! Element e22 should equal e21 + 1: " + this);
		Precondition.checkDomain(mat.getE22() > 0, "e21", mat.getE21(), "[1,inf)");
	...
	public HazelNodeMatrix(long index) {
		...
		Precondition.checkDomain(index > 0, "node", index, "[1,inf)");
